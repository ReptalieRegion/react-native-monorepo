import { FastListItemTypes, fastListItemRecycler, type FastListItem } from './fast-list-item-recycler';
...
class FastListComputer {
    ...
    compute(
        ...
        const recycler = fastListItemRecycler(prevItems);
        ...
        function mergeSections() {
            ...
            for (firstItemIndex; firstItemIndex < items.length; firstItemIndex++) {
                ...
                if (item.type !== FastListItemTypes.SECTION && item.type !== FastListItemTypes.SPACER) {
                    break;
                }
            }
...
export default FastListComputer;
